...
import{UserListing} from 'src/app/models/userlisting';
...
export class AddComponent implements OnInit {
  ...
  {    
   ...
   this.taskForm.patchValue({
    projectName : values.split('-')[1],
    projectId : values.split('-')[0]
  });
  }


selectedparenttasks(seltaks)
{
  this.taskForm.patchValue({
...
this.taskForm.patchValue({
  ...
  loadDependencies() {
    ...
    this._taskService.getAllParentTasks().subscribe((data: Array<Task>) => {
